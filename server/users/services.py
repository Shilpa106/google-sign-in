...
def user_create(email,username=None, password=None, **extra_fields) -> User:
    extra_fields = {
        'is_staff': False,
        'is_superuser': False,
        **extra_fields
...
def user_create_superuser(email,username=None, password=None, **extra_fields) -> User:
    extra_fields = {
        **extra_fields,
        'is_staff': True,
        'is_superuser': True,
    ...
    user = user_create(email=email, password=password,username=username, **extra_fields)
